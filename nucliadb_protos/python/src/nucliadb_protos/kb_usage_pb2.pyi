...
class KbUsage(google.protobuf.message.Message):
    ...
    LOG_MATCH_ID_FIELD_NUMBER: builtins.int
    ...
    def __init__(
        ...
        *,
        ...
        kb_source: global___KBSource.ValueType = ...,
        log_match_id: builtins.str | None = ...,
    ...
    def HasField(self, field_name: typing.Literal["_account_id", b"_account_id", "_kb_id", b"_kb_id", "_log_match_id", b"_log_match_id", "_storage", b"_storage", "account_id", b"account_id", "kb_id", b"kb_id", "log_match_id", b"log_match_id", "storage", b"storage", "timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_account_id", b"_account_id", "_kb_id", b"_kb_id", "_log_match_id", b"_log_match_id", "_storage", b"_storage", "account_id", b"account_id", "kb_id", b"kb_id", "kb_source", b"kb_source", "log_match_id", b"log_match_id", "predicts", b"predicts", "processes", b"processes", "searches", b"searches", "service", b"service", "storage", b"storage", "timestamp", b"timestamp"]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_log_match_id", b"_log_match_id"]) -> typing.Literal["log_match_id"] | None: ...
    @typing.overload
