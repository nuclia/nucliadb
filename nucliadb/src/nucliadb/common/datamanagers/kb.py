...
async def has_external_index_provider(txn: Transaction, *, kbid: str) -> bool:
    external_provider = await get_external_index_provider_metadata(txn, kbid=kbid)
    return external_provider is not None
