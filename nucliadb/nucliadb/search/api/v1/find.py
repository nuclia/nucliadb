...
async def find_knowledgebox(
    ...
    response: Response,
    kbid: str,
    query: str = Query(**Defaults.query),
    advanced_query: Optional[str] = Query(**Defaults.advanced_query),
    fields: List[str] = Query(**Defaults.fields),
    filters: List[str] = Query(**Defaults.filters),
    faceted: List[str] = Query(**Defaults.faceted),
    ...
    min_score: float = Query(**Defaults.min_score),
