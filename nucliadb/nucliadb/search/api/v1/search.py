...
async def search_knowledgebox(
    ...
    response: Response,
    kbid: str,
    query: str = Query(**FieldDefaults.query),
    advanced_query: Optional[str] = Query(**FieldDefaults.advanced_query),
    fields: List[str] = Query(**FieldDefaults.fields),
    filters: List[str] = Query(**FieldDefaults.filters),
    faceted: List[str] = Query(**FieldDefaults.faceted),
    ...
    min_score: float = Query(**FieldDefaults.min_score),
