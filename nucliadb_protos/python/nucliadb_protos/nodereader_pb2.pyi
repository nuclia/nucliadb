...
class RelationType(google.protobuf.message.Message):
    ...
    HAS_SUBTYPE_FIELD_NUMBER: builtins.int
    with_type: typing.Text
    with_subtype: typing.Text
    has_subtype: builtins.bool
    def __init__(self,
        *,
        with_type: typing.Text = ...,
        with_subtype: typing.Text = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["has_subtype",b"has_subtype","with_subtype",b"with_subtype","with_type",b"with_type"]) -> None: ...
...
class TypeList(google.protobuf.message.Message):
    ...
    LIST_FIELD_NUMBER: builtins.int
    @property
    def list(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___RelationType]: ...
    def __init__(self,
        *,
        list: typing.Optional[typing.Iterable[global___RelationType]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["list",b"list"]) -> None: ...
