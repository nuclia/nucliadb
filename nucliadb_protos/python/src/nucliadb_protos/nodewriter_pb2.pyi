...
class VectorIndexConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_vector_dimension", b"_vector_dimension", "vector_dimension", b"vector_dimension"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_vector_dimension", b"_vector_dimension", "normalize_vectors", b"normalize_vectors", "similarity", b"similarity", "vector_dimension", b"vector_dimension", "vector_type", b"vector_type"]) -> None: ...
...
class NewShardRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["config", b"config", "kbid", b"kbid", "normalize_vectors", b"normalize_vectors", "release_channel", b"release_channel", "similarity", b"similarity", "vectorsets_configs", b"vectorsets_configs"]) -> None: ...
...
class NewVectorSetRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["config", b"config", "id", b"id", "normalize_vectors", b"normalize_vectors", "similarity", b"similarity"]) -> None: ...
