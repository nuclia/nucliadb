/*
    ...
    All stored data types, must be serialized and deserealized with bincode and will implment Default.
    ...
    this module should provide the following functionality: 
        ...
        -> /* Only if a locked lock is provided */ create a new txn with a given id and return segment and delete_log files ready to be writen to.
