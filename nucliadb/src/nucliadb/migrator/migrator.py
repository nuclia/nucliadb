...
async def run_pg_schema_migrations(driver: PGDriver):
    ...
    async with driver.transaction(read_only=False) as tx_lock, tx_lock.connection.cursor() as cur_lock:  # type: ignore[attr-defined]
        ...
        for version, migration in migrations:
            ...
            async with driver.transaction(read_only=False) as tx, tx.connection.cursor() as cur:  # type: ignore[attr-defined]
