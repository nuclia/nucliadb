...
class Basic(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_hidden", b"_hidden", "computedmetadata", b"computedmetadata", "created", b"created", "hidden", b"hidden", "metadata", b"metadata", "modified", b"modified", "usermetadata", b"usermetadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_hidden", b"_hidden", "computedmetadata", b"computedmetadata", "created", b"created", "fieldmetadata", b"fieldmetadata", "hidden", b"hidden", "icon", b"icon", "labels", b"labels", "last_account_seq", b"last_account_seq", "last_seqid", b"last_seqid", "layout", b"layout", "metadata", b"metadata", "modified", b"modified", "queue", b"queue", "slug", b"slug", "summary", b"summary", "thumbnail", b"thumbnail", "title", b"title", "usermetadata", b"usermetadata", "uuid", b"uuid"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_hidden", b"_hidden"]) -> typing_extensions.Literal["hidden"] | None: ...
...
class EmailMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["sent_date", b"sent_date"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["participants", b"participants", "sent_date", b"sent_date", "subject", b"subject"]) -> None: ...
...
class FileExtractedData(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["email_metadata", b"email_metadata", "file_pages_previews", b"file_pages_previews", "file_preview", b"file_preview", "file_thumbnail", b"file_thumbnail"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["email_metadata", b"email_metadata", "field", b"field", "file_generated", b"file_generated", "file_pages_previews", b"file_pages_previews", "file_preview", b"file_preview", "file_rows_previews", b"file_rows_previews", "file_thumbnail", b"file_thumbnail", "icon", b"icon", "language", b"language", "md5", b"md5", "metadata", b"metadata", "nested", b"nested", "nested_list_position", b"nested_list_position", "nested_position", b"nested_position"]) -> None: ...
...
class ExtractedVectorsWrapper(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["field", b"field", "file", b"file", "file_or_data", b"file_or_data", "vectors", b"vectors", "vectorset_id", b"vectorset_id"]) -> None: ...
...
class FieldMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["classifications", b"classifications", "language", b"language", "last_extract", b"last_extract", "last_index", b"last_index", "last_summary", b"last_summary", "last_understanding", b"last_understanding", "links", b"links", "mime_type", b"mime_type", "ner", b"ner", "paragraphs", b"paragraphs", "positions", b"positions", "relations", b"relations", "summary", b"summary", "thumbnail", b"thumbnail"]) -> None: ...
...
class FieldQuestionAnswers(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["question_answers", b"question_answers"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["deleted_splits", b"deleted_splits", "question_answers", b"question_answers", "split_question_answers", b"split_question_answers"]) -> None: ...
