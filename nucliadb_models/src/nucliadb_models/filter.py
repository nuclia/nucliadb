...
class And(BaseModel, Generic[F], extra=pydantic.Extra.forbid):
    """AND of other expressions"""

    operands: list[F] = pydantic.Field(alias="and")


class Or(BaseModel, Generic[F], extra=pydantic.Extra.forbid):
    """OR of other expressions"""

    operands: list[F] = pydantic.Field(alias="or")


class Not(BaseModel, Generic[F], extra=pydantic.Extra.forbid):
    """NOT another expression"""

    operand: F = pydantic.Field(alias="not")


class Resource(BaseModel, extra=pydantic.Extra.forbid):
...
class Field(BaseModel, extra=pydantic.Extra.forbid):
...
class Keyword(BaseModel, extra=pydantic.Extra.forbid):
...
class DateCreated(BaseModel, extra=pydantic.Extra.forbid):
...
class DateModified(BaseModel, extra=pydantic.Extra.forbid):
...
class OriginTag(BaseModel, extra=pydantic.Extra.forbid):
...
class Label(BaseModel, extra=pydantic.Extra.forbid):
...
class ResourceMimetype(BaseModel, extra=pydantic.Extra.forbid):
...
class FieldMimetype(BaseModel, extra=pydantic.Extra.forbid):
...
class Entity(BaseModel, extra=pydantic.Extra.forbid):
...
class Language(BaseModel, extra=pydantic.Extra.forbid):
...
class OriginMetadata(BaseModel, extra=pydantic.Extra.forbid):
...
class OriginPath(BaseModel, extra=pydantic.Extra.forbid):
...
class Generated(BaseModel, extra=pydantic.Extra.forbid):
...
class Kind(BaseModel, extra=pydantic.Extra.forbid):
...
class FilterExpression(BaseModel, extra=pydantic.Extra.forbid):
