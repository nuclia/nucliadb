...
async def neighbouring_paragraphs_prompt_context(
    ...
    hydration = Hydration(
        ...
        paragraph=ParagraphHydration(
            ...
            table=None,
            page=None,
            related=RelatedParagraphHydration(
                neighbours=NeighbourParagraphHydration(
    ...
    for paragraph_id in retrieved_paragraphs_ids:
        ...
        for neighbour_id in related:
            hydrated_neighbour = hydrated.paragraphs.get(neighbour_id)
...
async def __neighbouring_paragraphs_prompt_context(
    context: CappedPromptContext,
    kbid: str,
    ordered_text_blocks: list[FindParagraph],
    strategy: NeighbouringParagraphsStrategy,
