...
class ParagraphStreamingBatch(google.protobuf.message.Message):
    ...
    DATA_FIELD_NUMBER: builtins.int
    @property
    def data(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Paragraph]: ...
    def __init__(
        self,
        *,
        data: collections.abc.Iterable[global___Paragraph] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data"]) -> None: ...
