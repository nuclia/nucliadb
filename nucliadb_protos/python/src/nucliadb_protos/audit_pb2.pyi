...
class FeedbackAudit(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_feedback", b"_feedback", "_text_block_id", b"_text_block_id", "feedback", b"feedback", "text_block_id", b"text_block_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_feedback", b"_feedback", "_text_block_id", b"_text_block_id", "feedback", b"feedback", "good", b"good", "learning_id", b"learning_id", "task", b"task", "text_block_id", b"text_block_id"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_feedback", b"_feedback"]) -> typing_extensions.Literal["feedback"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_text_block_id", b"_text_block_id"]) -> typing_extensions.Literal["text_block_id"] | None: ...
...
class AuditRequest(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_user_request", b"_user_request"]) -> typing_extensions.Literal["user_request"] | None: ...
