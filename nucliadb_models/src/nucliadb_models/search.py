...
class PreQuery(BaseModel):
    ...
    name: Optional[str] = Field(
        ...
        min_length=1,
        max_length=100,
        description="Name of the prequery. If not specified, the name is autogenerated based on the index of the prequery in the list.",
    )
...
class SyncAskResponse(BaseModel):
    ...
    prequeries_retrieval_results: Optional[Dict[str, KnowledgeboxFindResults]] = Field(
        default=None,
        title="Prequeries retrieval results",
...
class PrequeriesAskResponseItem(BaseModel):
    type: Literal["prequeries_retrieval"] = "prequeries_retrieval"
