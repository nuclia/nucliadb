...
class ChatContext(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        author: builtins.str = ...,
        text: builtins.str = ...,
        pointer: builtins.str | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_pointer", b"_pointer", "pointer", b"pointer"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_pointer", b"_pointer", "author", b"author", "pointer", b"pointer", "text", b"text"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_pointer", b"_pointer"]) -> typing.Literal["pointer"] | None: ...
