...
pub struct Basic {
    ...
    pub modified: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct FileExtractedData {
    ...
    pub file_rows_previews:
        ::std::collections::HashMap<::prost::alloc::string::String, RowsPreview>,
    #[prost(message, optional, tag = "7")]
    ...
    pub nested_position:
        ::std::collections::HashMap<::prost::alloc::string::String, NestedPosition>,
}
#[derive(Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct LinkExtractedData {
    #[prost(message, optional, tag = "1")]
    pub date: ::core::option::Option<::prost_wkt_types::Timestamp>,
    #[prost(string, tag = "2")]
    pub language: ::prost::alloc::string::String,
    #[prost(string, tag = "4")]
    pub title: ::prost::alloc::string::String,
...
pub struct FieldMetadata {
    ...
    pub classifications: ::prost::alloc::vec::Vec<Classification>,
    #[prost(message, optional, tag = "5")]
    pub last_index: ::core::option::Option<::prost_wkt_types::Timestamp>,
    #[prost(message, optional, tag = "6")]
    pub last_understanding: ::core::option::Option<::prost_wkt_types::Timestamp>,
    #[prost(message, optional, tag = "7")]
    pub last_extract: ::core::option::Option<::prost_wkt_types::Timestamp>,
    #[prost(message, optional, tag = "8")]
    pub last_summary: ::core::option::Option<::prost_wkt_types::Timestamp>,
    #[prost(message, optional, tag = "9")]
...
pub struct FieldLink {
    #[prost(message, optional, tag = "1")]
    pub added: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct LargeComputedMetadata {
    ...
    #[prost(map = "string, message", tag = "2")]
    pub split_metadata:
        ::std::collections::HashMap<::prost::alloc::string::String, FieldLargeMetadata>,
    #[prost(string, repeated, tag = "3")]
    pub deleted_splits: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
#[derive(Serialize, Deserialize)]
