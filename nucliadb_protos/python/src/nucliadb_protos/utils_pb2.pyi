...
class RelationMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_origin", b"_origin", "_paragraph_id", b"_paragraph_id", "_source_end", b"_source_end", "_source_start", b"_source_start", "_to_end", b"_to_end", "_to_start", b"_to_start", "origin", b"origin", "paragraph_id", b"paragraph_id", "source_end", b"source_end", "source_start", b"source_start", "to_end", b"to_end", "to_start", b"to_start"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_origin", b"_origin", "_paragraph_id", b"_paragraph_id", "_source_end", b"_source_end", "_source_start", b"_source_start", "_to_end", b"_to_end", "_to_start", b"_to_start", "origin", b"origin", "paragraph_id", b"paragraph_id", "source_end", b"source_end", "source_start", b"source_start", "to_end", b"to_end", "to_start", b"to_start"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_origin", b"_origin"]) -> typing_extensions.Literal["origin"] | None: ...
    @typing.overload
