...
@typing.final
class DataAugmentationCleanup(google.protobuf.message.Message):
    """This message is used by the data augmentation tasks when a task is deleted and
    the users want to cleanup all the data generated by the task.
    """
    ...
    TEXT_FIELDS_FIELD_NUMBER: builtins.int
...
class BrokerMessage(google.protobuf.message.Message):
    ...
    DATA_AUGMENTATION_CLEANUP_FIELD_NUMBER: builtins.int
    kbid: builtins.str
    uuid: builtins.str
    slug: builtins.str
    ...
    @property
    def data_augmentation_cleanup(self) -> global___DataAugmentationCleanup: ...
    def __init__(
        self,
        *,
        kbid: builtins.str = ...,
