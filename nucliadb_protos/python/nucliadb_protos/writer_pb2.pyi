...
class Audit(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["origin", b"origin", "source", b"source", "user", b"user", "when", b"when"]) -> None: ...
...
class DelVectorSetRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["kb", b"kb"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["kb", b"kb", "vectorset", b"vectorset"]) -> None: ...
...
class SetVectorSetRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["kb", b"kb", "vectorset", b"vectorset"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["id", b"id", "kb", b"kb", "vectorset", b"vectorset"]) -> None: ...
...
class Notification(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["action", b"action", "kbid", b"kbid", "message", b"message", "multi", b"multi", "partition", b"partition", "processing_errors", b"processing_errors", "seqid", b"seqid", "source", b"source", "uuid", b"uuid", "write_type", b"write_type"]) -> None: ...
...
class BinaryMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["content_type", b"content_type", "filename", b"filename", "kbid", b"kbid", "key", b"key", "size", b"size"]) -> None: ...
...
class UploadBinaryData(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["data", b"data", "metadata", b"metadata", "payload", b"payload"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["count", b"count", "data", b"data", "metadata", b"metadata", "payload", b"payload"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["data", b"data"]) -> typing.Literal["metadata", "payload"] | None: ...
...
class SetSynonymsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["kbid", b"kbid", "synonyms", b"synonyms"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["kbid", b"kbid", "synonyms", b"synonyms"]) -> None: ...
...
class GetSynonymsResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["status", b"status", "synonyms", b"synonyms"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["status", b"status", "synonyms", b"synonyms"]) -> None: ...
