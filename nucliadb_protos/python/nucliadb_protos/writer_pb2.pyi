...
class BrokerMessage(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        source: global___BrokerMessage.MessageSource.ValueType = ...,
        account_seq: builtins.int = ...,
        user_vectors: typing.Optional[typing.Iterable[nucliadb_protos.resources_pb2.UserVectorsWrapper]] = ...,
        ) -> None: ...
...
class GetVectorSetsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        kb: typing.Optional[nucliadb_protos.knowledgebox_pb2.KnowledgeBoxID] = ...,
        vectorsets: typing.Optional[nucliadb_protos.knowledgebox_pb2.VectorSets] = ...,
        status: global___GetVectorSetsResponse.Status.ValueType = ...,
        ) -> None: ...
...
class SetVectorSetRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        kb: typing.Optional[nucliadb_protos.knowledgebox_pb2.KnowledgeBoxID] = ...,
        id: typing.Text = ...,
        vectorset: typing.Optional[nucliadb_protos.knowledgebox_pb2.VectorSet] = ...,
        ) -> None: ...
...
class ShadowShard(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        shard: typing.Optional[nucliadb_protos.noderesources_pb2.ShardId] = ...,
        node: typing.Text = ...,
        ) -> None: ...
...
class ShardReplica(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        node: typing.Text = ...,
        shadow_replica: typing.Optional[global___ShadowShard] = ...,
        ) -> None: ...
...
class UploadBinaryData(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        count: builtins.int = ...,
        metadata: typing.Optional[global___BinaryMetadata] = ...,
        payload: builtins.bytes = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["data",b"data"]) -> typing.Optional[typing_extensions.Literal["metadata","payload"]]: ...
...
class ShadowShardResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        shadow_shard: typing.Optional[global___ShadowShard] = ...,
        success: builtins.bool = ...,
        ) -> None: ...
...
class SetSynonymsRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        kbid: typing.Optional[nucliadb_protos.knowledgebox_pb2.KnowledgeBoxID] = ...,
        synonyms: typing.Optional[nucliadb_protos.knowledgebox_pb2.Synonyms] = ...,
        ) -> None: ...
...
class GetSynonymsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        status: typing.Optional[global___OpStatusWriter] = ...,
        synonyms: typing.Optional[nucliadb_protos.knowledgebox_pb2.Synonyms] = ...,
        ) -> None: ...
