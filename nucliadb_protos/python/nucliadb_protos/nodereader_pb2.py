...
try:
    nucliadb__protos_dot_utils__pb2 = (
        nucliadb__protos_dot_noderesources__pb2.nucliadb__protos_dot_utils__pb2
    )
except AttributeError:
    nucliadb__protos_dot_utils__pb2 = (
        nucliadb__protos_dot_noderesources__pb2.nucliadb_protos.utils_pb2
    )
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "nucliadb_protos.nodereader_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _NODEREADER._serialized_start = 4546
    _NODEREADER._serialized_end = 5586
