...
class Audit(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audit_fields", b"audit_fields", "field_metadata", b"field_metadata", "kbid", b"kbid", "message_source", b"message_source", "origin", b"origin", "source", b"source", "user", b"user", "uuid", b"uuid", "when", b"when"]) -> None: ...
...
class Notification(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["message", b"message", "message_audit", b"message_audit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["action", b"action", "kbid", b"kbid", "message", b"message", "message_audit", b"message_audit", "multi", b"multi", "partition", b"partition", "processing_errors", b"processing_errors", "seqid", b"seqid", "source", b"source", "uuid", b"uuid", "write_type", b"write_type"]) -> None: ...
...
class NewVectorSetRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["kbid", b"kbid", "matryoshka_dimensions", b"matryoshka_dimensions", "normalize_vectors", b"normalize_vectors", "similarity", b"similarity", "vector_dimension", b"vector_dimension", "vector_type", b"vector_type", "vectorset_id", b"vectorset_id"]) -> None: ...
...
class NewVectorSetResponse(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[NewVectorSetResponse._Status.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class DelVectorSetRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["kbid", b"kbid", "vectorset_id", b"vectorset_id"]) -> None: ...
...
class DelVectorSetResponse(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[DelVectorSetResponse._Status.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class NewKnowledgeBoxV2Request(google.protobuf.message.Message):
    ...
    class VectorSet(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["matryoshka_dimensions", b"matryoshka_dimensions", "similarity", b"similarity", "vector_dimension", b"vector_dimension", "vectorset_id", b"vectorset_id"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["external_index_provider", b"external_index_provider"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "external_index_provider", b"external_index_provider", "hidden_resources_enabled", b"hidden_resources_enabled", "hidden_resources_hide_on_creation", b"hidden_resources_hide_on_creation", "kbid", b"kbid", "slug", b"slug", "title", b"title", "vectorsets", b"vectorsets"]) -> None: ...
