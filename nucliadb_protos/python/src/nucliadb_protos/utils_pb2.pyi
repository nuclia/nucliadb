...
class Relation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["metadata", b"metadata", "relation", b"relation", "relation_label", b"relation_label", "resource_id", b"resource_id", "source", b"source", "to", b"to"]) -> None: ...
