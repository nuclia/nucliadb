...
async def search_knowledgebox(
    ...
    response: Response,
    kbid: str,
    query: str = Query(**ParamDefaults.query),
    advanced_query: Optional[str] = Query(**ParamDefaults.advanced_query),
    fields: List[str] = Query(**ParamDefaults.fields),
    filters: List[str] = Query(**ParamDefaults.filters),
    faceted: List[str] = Query(**ParamDefaults.faceted),
    ...
    min_score: float = Query(**ParamDefaults.min_score),
