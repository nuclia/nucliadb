...
class PrimaryShardReplicationState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_normalize_vectors", b"_normalize_vectors", "_similarity", b"_similarity", "normalize_vectors", b"normalize_vectors", "similarity", b"similarity"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_normalize_vectors", b"_normalize_vectors", "_similarity", b"_similarity", "generation_id", b"generation_id", "kbid", b"kbid", "normalize_vectors", b"normalize_vectors", "release_channel", b"release_channel", "shard_id", b"shard_id", "similarity", b"similarity"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_normalize_vectors", b"_normalize_vectors"]) -> typing_extensions.Literal["normalize_vectors"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_similarity", b"_similarity"]) -> typing_extensions.Literal["similarity"] | None: ...
