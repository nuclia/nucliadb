...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PREDICTTYPE']._serialized_end=1570
  _globals['_CLIENTTYPE']._serialized_start=1572
  _globals['_CLIENTTYPE']._serialized_end=1678
