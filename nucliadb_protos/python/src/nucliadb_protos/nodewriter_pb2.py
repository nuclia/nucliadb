...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _OPSTATUS.fields_by_name['field_count']._options = None
  _OPSTATUS.fields_by_name['field_count']._serialized_options = b'\030\001'
  _OPSTATUS.fields_by_name['paragraph_count']._options = None
  _OPSTATUS.fields_by_name['paragraph_count']._serialized_options = b'\030\001'
  _OPSTATUS.fields_by_name['sentence_count']._options = None
  _OPSTATUS.fields_by_name['sentence_count']._serialized_options = b'\030\001'
  _OPSTATUS.fields_by_name['shard_id']._options = None
  _OPSTATUS.fields_by_name['shard_id']._serialized_options = b'\030\001'
  _NEWSHARDREQUEST_VECTORSETSCONFIGSENTRY._options = None
  _NEWSHARDREQUEST_VECTORSETSCONFIGSENTRY._serialized_options = b'8\001'
  _NEWSHARDREQUEST.fields_by_name['similarity']._options = None
  _NEWSHARDREQUEST.fields_by_name['similarity']._serialized_options = b'\030\001'
  _NEWSHARDREQUEST.fields_by_name['normalize_vectors']._options = None
  _NEWSHARDREQUEST.fields_by_name['normalize_vectors']._serialized_options = b'\030\001'
  _NEWSHARDREQUEST.fields_by_name['config']._options = None
  _NEWSHARDREQUEST.fields_by_name['config']._serialized_options = b'\030\001'
  _NEWVECTORSETREQUEST.fields_by_name['similarity']._options = None
  _NEWVECTORSETREQUEST.fields_by_name['similarity']._serialized_options = b'\030\001'
  _NEWVECTORSETREQUEST.fields_by_name['normalize_vectors']._options = None
  _NEWVECTORSETREQUEST.fields_by_name['normalize_vectors']._serialized_options = b'\030\001'
  _TYPEMESSAGE._serialized_start=1605
  _TYPEMESSAGE._serialized_end=1646
  _INDEXMESSAGESOURCE._serialized_start=1648
  _INDEXMESSAGESOURCE._serialized_end=1695
  _VECTORTYPE._serialized_start=1697
  _VECTORTYPE._serialized_end=1724
  _OPSTATUS._serialized_start=86
  _OPSTATUS._serialized_end=303
  _OPSTATUS_STATUS._serialized_start=263
  _OPSTATUS_STATUS._serialized_end=303
  _INDEXMESSAGE._serialized_start=306
  _INDEXMESSAGE._serialized_end=568
  _GARBAGECOLLECTORRESPONSE._serialized_start=570
  _GARBAGECOLLECTORRESPONSE._serialized_end=690
  _GARBAGECOLLECTORRESPONSE_STATUS._serialized_start=659
  _GARBAGECOLLECTORRESPONSE_STATUS._serialized_end=690
  _VECTORINDEXCONFIG._serialized_start=693
  _VECTORINDEXCONFIG._serialized_end=881
  _NEWSHARDREQUEST._serialized_start=884
  _NEWSHARDREQUEST._serialized_end=1263
  _NEWSHARDREQUEST_VECTORSETSCONFIGSENTRY._serialized_start=1176
  _NEWSHARDREQUEST_VECTORSETSCONFIGSENTRY._serialized_end=1263
  _NEWVECTORSETREQUEST._serialized_start=1266
  _NEWVECTORSETREQUEST._serialized_end=1454
  _MERGERESPONSE._serialized_start=1457
  _MERGERESPONSE._serialized_end=1603
  _MERGERESPONSE_MERGESTATUS._serialized_start=1582
  _MERGERESPONSE_MERGESTATUS._serialized_end=1603
  _NODEWRITER._serialized_start=1727
  _NODEWRITER._serialized_end=2576
