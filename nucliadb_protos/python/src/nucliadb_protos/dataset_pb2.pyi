...
class TrainSet(google.protobuf.message.Message):
    ...
    class Filter(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["entities", b"entities", "fields", b"fields", "icons", b"icons", "labels", b"labels", "metadata", b"metadata", "paths", b"paths", "rids", b"rids", "status", b"status", "tags", b"tags"]) -> None: ...
...
class FieldSplitData(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["basic", b"basic", "file", b"file", "link", b"link", "metadata", b"metadata", "text", b"text"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["basic", b"basic", "field", b"field", "field_type", b"field_type", "file", b"file", "labels", b"labels", "link", b"link", "metadata", b"metadata", "rid", b"rid", "split", b"split", "text", b"text"]) -> None: ...
