...
class SuggestResponse(google.protobuf.message.Message):
    ...
    total: builtins.int = ...
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SuggestResponse.Result]: ...
    def __init__(self,
        *,
        total : builtins.int = ...,
        results : typing.Optional[typing.Iterable[global___SuggestResponse.Result]] = ...,
        ) -> None: ...
