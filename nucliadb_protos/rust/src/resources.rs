...
pub struct FileExtractedData {
    ...
    pub nested_list_position:
        ::std::collections::HashMap<::prost::alloc::string::String, NestedListPosition>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct UserVectorsWrapper {
    ...
    #[prost(map = "string, message", tag = "13")]
    pub vectors_to_delete:
        ::std::collections::HashMap<::prost::alloc::string::String, super::utils::UserVectorsList>,
    #[prost(message, optional, tag = "3")]
    pub field: ::core::option::Option<FieldId>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
