...
class Positions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_data_augmentation_task_id", b"_data_augmentation_task_id", "data_augmentation_task_id", b"data_augmentation_task_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_data_augmentation_task_id", b"_data_augmentation_task_id", "data_augmentation_task_id", b"data_augmentation_task_id", "entity", b"entity", "position", b"position"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_data_augmentation_task_id", b"_data_augmentation_task_id"]) -> typing_extensions.Literal["data_augmentation_task_id"] | None: ...
