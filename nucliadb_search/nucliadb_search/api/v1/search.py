...
async def search_knowledgebox(
    ...
    max_score: float = Query(0.85),
    range_creation_start: Optional[datetime] = Query(None),
    range_creation_end: Optional[datetime] = Query(None),
    range_modification_start: Optional[datetime] = Query(None),
    range_modification_end: Optional[datetime] = Query(None),
