...
class Resource(google.protobuf.message.Message):
    ...
    TEXT_FIELDS_TO_DELETE_FIELD_NUMBER: builtins.int
    ...
    INDEX_TEXTS_FIELD_NUMBER: builtins.int
    INDEX_PARAGRAPHS_FIELD_NUMBER: builtins.int
    INDEX_VECTORS_FIELD_NUMBER: builtins.int
    INDEX_RELATIONS_FIELD_NUMBER: builtins.int
    status: global___Resource.ResourceStatus.ValueType
    """Tantivy doc"""
    shard_id: builtins.str
    index_texts: builtins.bool
    """Boolean flags to indicate to each index whether to index new data"""
    index_paragraphs: builtins.bool
    index_vectors: builtins.bool
    index_relations: builtins.bool
    @property
    ...
    @property
    def text_fields_to_delete(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        text_fields_to_delete: collections.abc.Iterable[builtins.str] | None = ...,
    ...
    def ClearField(self, field_name: typing.Literal["_security", b"_security", "field_relations", b"field_relations", "index_paragraphs", b"index_paragraphs", "index_relations", b"index_relations", "index_texts", b"index_texts", "index_vectors", b"index_vectors", "labels", b"labels", "metadata", b"metadata", "paragraphs", b"paragraphs", "paragraphs_to_delete", b"paragraphs_to_delete", "relation_fields_to_delete", b"relation_fields_to_delete", "resource", b"resource", "security", b"security", "sentences_to_delete", b"sentences_to_delete", "shard_id", b"shard_id", "status", b"status", "text_fields_to_delete", b"text_fields_to_delete", "texts", b"texts", "vector_prefixes_to_delete", b"vector_prefixes_to_delete", "vectors", b"vectors", "vectors_to_delete", b"vectors_to_delete"]) -> None: ...
