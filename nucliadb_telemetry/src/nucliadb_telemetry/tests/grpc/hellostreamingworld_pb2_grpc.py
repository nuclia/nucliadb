...
from nucliadb_telemetry.tests.grpc import hellostreamingworld_pb2 as nucliadb__telemetry_dot_tests_dot_grpc_dot_hellostreamingworld__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in nucliadb_telemetry/tests/grpc/hellostreamingworld_pb2_grpc.py depends on'
