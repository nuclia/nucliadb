...
class FieldEntity(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["label", b"label", "positions", b"positions", "text", b"text"]) -> None: ...
...
class FieldMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["classifications", b"classifications", "entities", b"entities", "language", b"language", "last_extract", b"last_extract", "last_index", b"last_index", "last_summary", b"last_summary", "last_understanding", b"last_understanding", "links", b"links", "mime_type", b"mime_type", "ner", b"ner", "paragraphs", b"paragraphs", "positions", b"positions", "relations", b"relations", "summary", b"summary", "thumbnail", b"thumbnail"]) -> None: ...
...
class Answers(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["ids_paragraphs", b"ids_paragraphs", "language", b"language", "reason", b"reason", "text", b"text"]) -> None: ...
