...
from stashify_protos.protos.knowledgebox_pb2 import IndexConfig, IndexRequest
from stashify_protos.protos.knowledgebox_pb2_grpc import LearningServiceStub
