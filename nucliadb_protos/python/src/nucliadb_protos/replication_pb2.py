...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PRIMARYSHARDREPLICATIONSTATE.fields_by_name['similarity']._options = None
  _PRIMARYSHARDREPLICATIONSTATE.fields_by_name['similarity']._serialized_options = b'\030\001'
  _PRIMARYSHARDREPLICATIONSTATE.fields_by_name['normalize_vectors']._options = None
  _PRIMARYSHARDREPLICATIONSTATE.fields_by_name['normalize_vectors']._serialized_options = b'\030\001'
  ...
  _PRIMARYSHARDREPLICATIONSTATE._serialized_start=88
  _PRIMARYSHARDREPLICATIONSTATE._serialized_end=323
  _SECONDARYSHARDREPLICATIONSTATE._serialized_start=325
  _SECONDARYSHARDREPLICATIONSTATE._serialized_end=398
  _SECONDARYCHECKREPLICATIONSTATEREQUEST._serialized_start=401
  _SECONDARYCHECKREPLICATIONSTATEREQUEST._serialized_end=529
  _PRIMARYCHECKREPLICATIONSTATERESPONSE._serialized_start=532
  _PRIMARYCHECKREPLICATIONSTATERESPONSE._serialized_end=681
  _SEGMENTIDS._serialized_start=683
  _SEGMENTIDS._serialized_end=710
  _REPLICATESHARDREQUEST._serialized_start=713
  _REPLICATESHARDREQUEST._serialized_end=948
  _REPLICATESHARDREQUEST_EXISTINGSEGMENTIDSENTRY._serialized_start=866
  _REPLICATESHARDREQUEST_EXISTINGSEGMENTIDSENTRY._serialized_end=948
  _REPLICATESHARDRESPONSE._serialized_start=951
  _REPLICATESHARDRESPONSE._serialized_end=1088
  _REPLICATIONSERVICE._serialized_start=1091
  _REPLICATIONSERVICE._serialized_end=1410
