...
class IndexParagraph(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["metadata", b"metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["end", b"end", "field", b"field", "index", b"index", "labels", b"labels", "metadata", b"metadata", "repeated_in_field", b"repeated_in_field", "sentences", b"sentences", "split", b"split", "start", b"start"]) -> None: ...
