...
class ShadowShardCreateRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing_extensions.Literal["kbid", b"kbid", "node", b"node", "replica_id", b"replica_id"]) -> None: ...

global___ShadowShardCreateRequest = ShadowShardCreateRequest

class ShadowShardCreateResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ShadowShardCreateResponse = ShadowShardCreateResponse
