...
_VECTORSET = DESCRIPTOR.message_types_by_name['VectorSet']
_VECTORSETS = DESCRIPTOR.message_types_by_name['VectorSets']
_VECTORSETS_VECTORSETSENTRY = _VECTORSETS.nested_types_by_name['VectorsetsEntry']
...
VectorSet = _reflection.GeneratedProtocolMessageType('VectorSet', (_message.Message,), {
  'DESCRIPTOR' : _VECTORSET,
  '__module__' : 'nucliadb_protos.knowledgebox_pb2'
  # @@protoc_insertion_point(class_scope:knowledgebox.VectorSet)
  })
_sym_db.RegisterMessage(VectorSet)

VectorSets = _reflection.GeneratedProtocolMessageType('VectorSets', (_message.Message,), {

  'VectorsetsEntry' : _reflection.GeneratedProtocolMessageType('VectorsetsEntry', (_message.Message,), {
    'DESCRIPTOR' : _VECTORSETS_VECTORSETSENTRY,
    '__module__' : 'nucliadb_protos.knowledgebox_pb2'
    # @@protoc_insertion_point(class_scope:knowledgebox.VectorSets.VectorsetsEntry)
    })
  ,
  'DESCRIPTOR' : _VECTORSETS,
  '__module__' : 'nucliadb_protos.knowledgebox_pb2'
  # @@protoc_insertion_point(class_scope:knowledgebox.VectorSets)
  })
_sym_db.RegisterMessage(VectorSets)
_sym_db.RegisterMessage(VectorSets.VectorsetsEntry)
