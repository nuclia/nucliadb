...
def test_estimate_try_after(rate, pending, max_delta, delta):
    now = datetime.utcnow()
    try_after = estimate_try_after(rate, pending, max_delta)
