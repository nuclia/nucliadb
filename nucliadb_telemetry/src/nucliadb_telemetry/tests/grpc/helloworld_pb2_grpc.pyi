...
class GreeterServicer(metaclass=abc.ABCMeta):
    ...
    ) -> typing.Union[nucliadb_telemetry.tests.grpc.helloworld_pb2.HelloReply, collections.abc.Awaitable[nucliadb_telemetry.tests.grpc.helloworld_pb2.HelloReply]]:
        """Sends a greeting"""
