...
class CreatePineconeConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["api_key", b"api_key", "serverless_cloud", b"serverless_cloud"]) -> None: ...
...
class PineconeIndexMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["index_host", b"index_host", "index_name", b"index_name", "similarity", b"similarity", "vector_dimension", b"vector_dimension"]) -> None: ...
...
class StoredPineconeConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["encrypted_api_key", b"encrypted_api_key", "indexes", b"indexes", "serverless_cloud", b"serverless_cloud"]) -> None: ...
...
class CreateExternalIndexProviderMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["config", b"config", "pinecone_config", b"pinecone_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["config", b"config", "pinecone_config", b"pinecone_config", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["config", b"config"]) -> typing_extensions.Literal["pinecone_config"] | None: ...
...
class KnowledgeBoxConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "disable_vectors", b"disable_vectors", "enabled_filters", b"enabled_filters", "enabled_insights", b"enabled_insights", "external_index_provider", b"external_index_provider", "hidden_resources_enabled", b"hidden_resources_enabled", "hidden_resources_hide_on_creation", b"hidden_resources_hide_on_creation", "migration_version", b"migration_version", "release_channel", b"release_channel", "slug", b"slug", "title", b"title"]) -> None: ...
...
class VectorSetConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["vectorset_index_config", b"vectorset_index_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["matryoshka_dimensions", b"matryoshka_dimensions", "vectorset_id", b"vectorset_id", "vectorset_index_config", b"vectorset_index_config"]) -> None: ...
